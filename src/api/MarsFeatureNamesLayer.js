 ...
 */
export default class MarsFeatureNamesLayer extends WorldWind.WmsLayer {
  /**
  ...
  constructor() {
    let cfg = {
      title: "Feature Names",
      version: "1.3.0",
      service: "https://wms.wr.usgs.gov/cgi-bin/mapserv?map=/maps/mars/mars_nomen_wms.map&",
      layerNames: "NOMENCLATURE_180",
