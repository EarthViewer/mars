 ...
 */
export default class Mars500kQuadsLayer extends WorldWind.WmsLayer {
  /**
  ...
  constructor() {
    let cfg = {
      title: "500K Quads",
      version: "1.3.0",
      service: "https://planetarymaps.usgs.gov/cgi-bin/mapserv?map=/maps/mars/mars_simp_cyl_quads.map&",
      layerNames: "Mars500K_Quads",
